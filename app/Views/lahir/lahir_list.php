...
<div class="card shadow mb-4">
    ...
    <div class="card-header py-3 mb-3">
        <div class="row ml-1 mr-1">
            ...
            <a href="<?= site_url('lahir/create'); ?>" class="btn btn-primary btn-sm ml-auto loading"><i class="fa fa-plus-circle"></i> Tambah Kelahiran</a>
        </div>
    </div>
    <div class="card-body">
