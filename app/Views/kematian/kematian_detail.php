            ...
            <div class="row">
                <div class="col-md-6">
                    <table class="table table-sm table-bordered">
                        ...
                        <tr>
                            <th width="38%">Tanggal kematian</th>
                ...
                <div class="col-md-6">
                    <table class="table table-sm table-bordered">
                        ...
                        <tr>
                            ...
                            <td><?= getPetugas($kematian['pencatat']); ?></td>
                        </tr>
                        <tr>
                            <th width="38%">Tanggal di Tambahkan</th>
                            <td><?= date('d-m-Y H:i:s', strtotime($kematian['timestamp'])); ?></td>
                        </tr>
                        <tr>
                            <th width="38%">Tanggal di Update</th>
                            <td><?= ($kematian['updated'] == null) ? '' : date('d-m-Y H:i:s', strtotime($kematian['updated'])); ?></td>
                        </tr>
                    </table>
                </div>
            </div>
