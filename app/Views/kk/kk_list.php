...
<div class="card shadow mb-4">
    ...
    <div class="card-header py-3 mb-3">
        <div class="row ml-1 mr-1">
            <h5 class="m-0 font-weight-bold text-primary">Kartu Keluarga</h5>
            <div class="ml-auto">

                <a href="<?= site_url('kk/import_foto_kk'); ?>" class="btn btn-secondary btn-sm loading"><i class="fa fa-upload"></i> Import Foto KK</a>
                <a href="<?= site_url('kk/import'); ?>" class="btn btn-info btn-sm loading"><i class="fa fa-upload"></i> Import KK</a>
                <a href="<?= site_url('kk/create'); ?>" class="btn btn-primary btn-sm loading"><i class="fa fa-plus-circle"></i> Tambah KK</a>
            </div>
        </div>
    </div>
    <div class="card-body">
