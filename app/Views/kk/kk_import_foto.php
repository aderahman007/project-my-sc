...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        ...
        <form id="form-kk" action="<?= $action; ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-row">
                <div class="col-md-12">
                    <label class="font-weight-bold">Pilih Foto Kartu Keluarga</label>
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-md-10">
                    <div class="custom-file">
                        ...
                        <input type="file" class="custom-file-input form-control input-group-sm <?= ($validation->hasError('foto_kk')) ? 'is-invalid' : ''; ?>" name="foto_kk[]" id="foto_kk" multiple>
