...
<body class="mx-5 my-5 text-black justify-content-center">
  ...
  <div class="row mt-5">
    <img src="<?= base_url('images/desa/' . $mnj_desa['logo']); ?>" class="rounded d-block mb-3 ml-5" alt="Logo" width="80px" height="80px">
    <div class="col text-center">
      <h4 class="mb-0 mx-auto"><?= $judul4; ?></h4>
      <h5 class="mb-0 mx-auto">Desa <?= getDesa($mnj_desa['desa']) . ' ' . getKabupaten($mnj_desa['kabupaten']); ?></h5>
      <?php if ($tahun != "") : ?>
        <h5 class="mb-3 mx-auto"><?= 'Per-Tahun ' . $tahun; ?></h5>
      <?php endif ?>
        ...
        <tbody>
          <?php foreach ($dusun as $key_dusun => $value_dusun) : ?>
            <tr>
              ...
              <td>
                <table style="margin-left: auto; margin-right: auto; border: white;">
                  <?php foreach ($rt as $key_rt => $value_rt) : ?>
                    <?php if ($value_dusun['id_rw'] == $value_rt['id_rw']) : ?>
                      <tr>
                        <td style="border: white !important;"><?= $value_rt['no_rt']; ?></td>
                      </tr>
                    <?php endif ?>
                  <?php endforeach ?>
                </table>
                  ...
                  <table style="margin-left: auto; margin-right: auto;">
                    <?php foreach ($rt as $key_rt => $value_rt) : ?>
                      <?php if ($value_rt['id_rw'] == $value_dusun['id_rw']) : ?>
                        <?php $p = 0; ?>
                        <tr>
                          <td style="border: white !important; text-align: center;">
