...
<div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
        <div class="row ml-1 mr-1">
            ...
            <button data-toggle="modal" data-target="#pindahModal" class="btn btn-primary btn-sm ml-auto"><i class="fa fa-plus-circle"></i> Tambah Mutasi Pindah</button>
        </div>
    </div>
    <div class="card-body">
...
<?= $this->include('pindah/pindah_modal'); ?>
<!-- Required Jquery -->
