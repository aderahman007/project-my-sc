                ...
                <div class="col-md-6">
                    <table class="table table-sm table-bordered">
                        ...
                        <tr>
                            ...
                            <td><?= getPetugas($pindah['pencatat']); ?></td>
                        </tr>
                        <tr>
                            <th width="38%">Tanggal Pindah</th>
                            <td><?= date('d-m-Y h:i:s', strtotime($pindah['timestamp'])); ?></td>
                        </tr>
                        <tr>
                            <th width="38%">Tanggal di Update</th>
                            <td><?= ($pindah['updated'] == null) ? '' : date('d-m-Y H:i:s', strtotime($pindah['updated'])); ?></td>
                        </tr>
                    </table>
                </div>
            </div>
